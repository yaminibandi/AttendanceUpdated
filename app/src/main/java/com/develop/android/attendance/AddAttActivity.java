...
public class AddAttActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //     totalRoll = (ArrayList<RollNumbers>) dataSnapshot.getValue();
                //  Log.e("hh",dataSnapshot.getValue()+""+totalRoll.get(0).getRollnum());
                getData(ll);
            }
    ...
    public void getData(LinearLayout ll){
        for(int i = 0; i < totalRoll.size(); i++) {
            ...
            cb.setId(i);
            ll.addView(cb);
//            if(previousRoll.contains(totalRoll.get(i))){
