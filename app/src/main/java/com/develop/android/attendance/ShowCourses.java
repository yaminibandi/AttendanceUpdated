...
public class ShowCourses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mRollDatabaseReference.child(courseYear).addChildEventListener(mRollChildEventListener);
    }
...
//    public int statusChange(final Courses thisCourse){
//        Query query=mStatusDatabaseReference.child(thisCourse.year).child(thisCourse.courseName);
//        final int[] flag = {0};
//        query.addListenerForSingleValueEvent(new ValueEventListener() {
//            @Override
...
//            }
//        });
//        Log.d("staites",flag[0]+"");
//        return flag[0];
//    }
    public  void gocourse(final Courses thisCourse){
